        ...
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm mb-8">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <a href="portfolio.php" class="flex items-center p-4 border border-gray-200 rounded-lg hover:border-purple-300 hover:bg-purple-50 transition-colors duration-200 group">
                        ...
                        <div>
                            <p class="font-medium text-gray-900">Gérer portfolio</p>
                            <p class="text-sm text-gray-600">Modifier, supprimer</p>
                        </div>
                    </a>
