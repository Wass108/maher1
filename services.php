				...
				<div class="col-lg-4 col-md-6">
					<div class="service-box">
						...
						<p>Nous sommes en mesure de prendre en
							...
							initiale jusqu'à la réalisation finale, en
				...
				<div class="col-lg-4 col-md-6">
					<div class="service-box">
						...
						<p>Le style contemporain allie une
							...
							vernaculaire puise dans les traditions
				...
				<div class="col-lg-4 col-md-6">
					<div class="service-box">
						...
						<p>Nous possédons une expertise
							...
							savoir-faire technique, sensibilité
				...
				<div class="col-lg-4 col-md-6">
					<div class="service-box">
						...
						<p>Nous avons une solide expérience dans la conception
							...
							ingénierie de pointe et souci
							du détail pour créer des
							structures qui définissent les
				...
				<div class="col-lg-4 col-md-6">
					<div class="service-box">
						...
						<p>Nous possédons une expérience
							...
							la rénovation de vos immeubles existants,
							mettant en valeur leur caractère unique
							tout en intégrant des technologies et des
				...
				<div class="col-lg-4 col-md-6">
					<div class="service-box">
						...
						<p>Le BIM (Building Information Modeling) est notre
							...
							Cela garantit une planification minutieuse, réduit
