...
<!-- Hero section start -->
	<section class="hero-section">
		...
		<div class="hero-slider">
			<div class="hero-slide-item set-bg" data-setbg="img/projects/Maison_hotes/01.jpg">
				<div class="slide-inner">
					<div class="slide-content">
					<h2>Maison <br>D'hôtes  </h2><br>
					</div>	
				</div>
			</div>	
			<div class="hero-slide-item set-bg" data-setbg="img/projects/Maison_hotes/02.jpg">
				<div class="slide-inner">
			</div>
			</div>	
			<div class="hero-slide-item set-bg" data-setbg="img/projects/Maison_hotes/03.jpg">
				<div class="slide-inner">
			</div>
			</div>	
			<div class="hero-slide-item set-bg" data-setbg="img/projects/Maison_hotes/04.jpg">
				<div class="slide-inner">
			</div>
			</div>	
			<div class="hero-slide-item set-bg" data-setbg="img/projects/Maison_hotes/05.jpg">
				<div class="slide-inner">
			</div>
			</div>	
		...
		<div class="container ">
			...
			<div class="row mb-5 justify-content-between">
				<div class="col-lg-6 mb-lg-0 mb-4">
					<img src="img/projects/Maison_hotes/04.jpg"  alt="Image" class="">
				</div>
				<div class="col-lg-5">
