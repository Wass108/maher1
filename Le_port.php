...
<!-- Hero section start -->
	<section class="hero-section">
		...
		<div class="hero-slider">
			<div class="hero-slide-item set-bg" data-setbg="img/projects/Le_port/01.jpg">
			...
			<div class="hero-slide-item set-bg" data-setbg="img/projects/Le_port/02.jpg">
				<div class="slide-inner">
			</div>
			</div>	
			<div class="hero-slide-item set-bg" data-setbg="img/projects/Le_port/03.jpg">
				<div class="slide-inner">
			</div>
			</div>	
			<div class="hero-slide-item set-bg" data-setbg="img/projects/Le_port/04.jpg">
				<div class="slide-inner">
			</div>
			</div>	
			<div class="hero-slide-item set-bg" data-setbg="img/projects/Le_port/05.jpg">
				<div class="slide-inner">
			</div>
			</div>	
		...
		<div class="container ">
			...
			<div class="row mb-5 justify-content-between">
				<div class="col-lg-6 mb-lg-0 mb-4">
					<img src="img/projects/Le_port/04.jpg"  alt="Image" class="">
				</div>
				<div class="col-lg-5">
