...
<!-- Hero section start -->
	<section class="hero-section">
		...
		<div class="hero-slider">
			<div class="hero-slide-item set-bg" data-setbg="img/projects/Hotel_Marina/01.jpg">
				<div class="slide-inner">
					<div class="slide-content">
					<h2>Hotel <br> Marina </h2><br>
					</div>	
				</div>
			</div>	
			<div class="hero-slide-item set-bg" data-setbg="img/projects/Hotel_Marina/02.jpg">
				<div class="slide-inner">
			</div>
			</div>	
			<div class="hero-slide-item set-bg" data-setbg="img/projects/Hotel_Marina/03.jpg">
				<div class="slide-inner">
			</div>
			</div>	
			<div class="hero-slide-item set-bg" data-setbg="img/projects/Hotel_Marina/04.jpg">
				<div class="slide-inner">
			</div>
			</div>	
